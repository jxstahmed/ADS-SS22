...
{
	for (auto aktuelleedges : adj)
	{
		if (std::find(aktuelleedges.begin(), aktuelleedges.end(), e) != aktuelleedges.end())
		{
			aktuelleedges.erase(std::find(aktuelleedges.begin(), aktuelleedges.end(), e));
			E--;
			return true;
		}
		else
